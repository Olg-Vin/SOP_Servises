...
public class Listener {
    static final String queueName = "MainQueue";
    @Autowired
    ...
    public void listen(String message) {
        ...
        System.out.println(messageFromDB);
        MessageDTO messageDTO = messageService.saveMessage(messageFromDB);

        sender.sendMessage("NotifierQueue", messageDTO.toString());
    }
}
